...
AFRAME.registerComponent("markerhandler", {
  ...
  askTableNumber: function () {
    var iconUrl = "https://raw.githubusercontent.com/HardhikErat/web-ar-assets/master/hunger.png";
  ...
  handleOrderSummary: async function () {
    ...
    currentOrders.map(i => {
      ...
      price.innerHTML = "Rs. " + orderSummary.current_orders[i].price;
      price.setAttribute("class", "text-center");

      quantity.innerHTML = orderSummary.current_orders[i].quantity;
      quantity.setAttribute("class", "text-center");

      subtotal.innerHTML = "Rs. " + orderSummary.current_orders[i].subtotal;
